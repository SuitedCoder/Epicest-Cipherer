...
function encrypt (message) {
  let result = ''
  let key = document.getElementById('codes').value
...
function decrypt (message) {
  ...
  document.getElementById('ciphers').value = result
  return result
}
 
//const messageEncrypt = encrypt(document.getElementById("ciphers").value, 'code')
